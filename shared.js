/* ============================================================
   HOTEL AVA – SHARED UTILITIES
   Common helpers and components used across the application
   ============================================================ */
...
const icons = {
  ...
  parking: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 17V7h3.5a2.5 2.5 0 0 1 0 5H9"/></svg>`,
  smoke: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 13h-4"/><path d="M18 17h-4"/><path d="M22 9h-4"/><path d="M2 13a3 3 0 0 0 3 3h7c.6 0 1.1-.4 1.2-1l1.6-6c.1-.6.6-1 1.2-1h3"/><path d="m11 13 1.5-6"/><path d="M13.5 13H15"/></svg>`,
  noSmoke: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" x2="22" y1="2" y2="22"/><path d="M18 13h4"/><path d="M18 17h4"/><path d="M18 9h4"/><path d="M7.5 13H12c.6 0 1.1-.4 1.2-1l1.6-6c.1-.6.6-1 1.2-1h3"/><path d="M11 13 9 20"/><path d="M5.5 13H5a3 3 0 0 1-3-3V7"/><path d="M2 13a3 3 0 0 0 3 3h.5"/></svg>`,
